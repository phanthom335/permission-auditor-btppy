    """
    Permission Auditor Btppy
    ========================
    Lightweight terminal utility built to clean your filesystem and configurations.
    ...
    APP_NAME    = "Permission Auditor Btppy"
    APP_VERSION = "1.0.0"
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Lightweight terminal utility built to clean your filesystem and configurations.")
